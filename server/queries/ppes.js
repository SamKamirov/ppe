const insertPPEQuery = (body) =>
    `INSERT INTO ppe(fullname, shortname, lifespan, to_be_returned, is_kit, size_type, unit_type) values ( 
        '${body.fullname}', '${body.shortname}', '${body.lifeSpan}' , ${Boolean(body.toBeReturned)}, ${Boolean(Number(body.isKit))}, ${Number(body.sizeType)}, '${body.unitType}');`
