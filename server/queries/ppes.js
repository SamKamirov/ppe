const insertPPEQuery = (body) =>
    `INSERT INTO ppe(fullname, shortname, ` +
    // `sertificate,`
    + ` lifespan, to_be_returned, is_kit, size_type, unit_type)
    values ('${body.fullname}', '${body.shortname}',` +
    // ` ${body.sertificateId},`
    + ` '${body.lifeSpan}' , ${Boolean(body.toBeReturned)},
