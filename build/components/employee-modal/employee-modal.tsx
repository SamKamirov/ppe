                    ...
                    <div className="modal-body">
                        <form name="modal-form" id="modal-form" encType="multipart/form-data" onSubmit={handleSubmit} onChange={handleChange}>
                            <div className="input-group">
                                ...
                                <input type="number" className="form-control" id="personellNumber" name="personellNumber" required />
                            </div>
                            <div className="input-group">
                            ...
                            <div className="input-group">
                                ...
                                <input type="text" className="form-control" id="middleName" name="middleName" required />
                            </div>
                            <div className="input-group">
                            ...
                            <div className="input-group">
                                ...
                                <input type="date" className="form-control" id="enterDate" name="enterDate" required />
                            </div>
                            <div className="input-group">
                            ...
                            <div className="input-group">
                                ...
                                <select className="form-select form-control" name="sex">
                                    <option value=""></option>
                            ...
                            <div className="input-group">
                                ...
                                <input type="text" className="form-control" id="clothesSize" name="clothesSize" required />
                            </div>
                            <div className="input-group">
                                <label htmlFor="shoeSize" className="input-group-text input-group-sm w-50">Размер обуви</label>
                                <input type="number" className="form-control" id="shoeSize" name="shoeSize" required />
                            </div>
                            <div className="input-group">
                                <label htmlFor="headwearSize" className="input-group-text input-group-sm w-50">Размер головного убора</label>
                                <input type="number" className="form-control" id="headwearSize" name="headwearSize" required />
                            </div>
                            <div className="input-group">
                                <label htmlFor="gasMaskSize" className="input-group-text input-group-sm w-50">Размер противогаза</label>
                                <input type="number" className="form-control" id="gasMaskSize" name="gasMaskSize" required />
                            </div>
